...
<!-- 					<div class="btn-group"> -->
<!-- 							<button type="button" id="import_deptInfo" class="btn btn-primary"> -->
<!-- 								<div class="visible-md visible-lg"> -->
...
<!-- 						</div> -->
						<div class="btn-group">
							<button type="button" id="export_whole_dept" class="btn btn-primary">
								<div class="visible-md visible-lg">
						...
						<div class="btn-group">
							<button type="button" id="synchroDept" class="btn btn-primary">
								<div class="visible-md visible-lg">
									<i class="icon icon-times"></i>&nbsp;同步通讯录
								</div>
								<div class="visible-xs visible-sm">
									<i class="icon icon-times"></i>
								</div>
				...
				<div
					...
					<!-- <div class="input-group-addon">选择单位</div> -->
...
<script src="<%=basePath %>business/system/sysDept/def.js"></script>
<script src="<%=basePath%>common/import/importInfo.js"></script>  <!-- 导入方法 -->
<script src="<%=basePath %>business/system/sysDept/list.js"></script>
