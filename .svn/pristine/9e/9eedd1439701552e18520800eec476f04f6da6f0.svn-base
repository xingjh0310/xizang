		...
		<div class="modal-dialog modal-lg" style="width:670px">
			<div class="modal-content">
				...
				<div class="modal-header" style="height: 40px">
					...
					<div style="position: relative; padding: 15px; overflow-y:hidden">
					...
					<table class=" table-bordered ">
						<tbody>
							<tr>
								...
								<td ><span class="td-span" id="title"></span></td>
								
							</tr>
							<tr>
								<td class="td-label"><span class="tr-span">所属分类:</span></td>
								<td ><span class="td-span" id="classifyName"></span></td>
								
							</tr>
							<tr>
								<td class="td-label"><span class="tr-span">发布部门:</span></td>
								<td ><span class="td-span" id="releaseDept"></span></td>
								
							</tr>
							<tr>
								<td class="td-label"><span class="tr-span">内容:</span></td>
								<td ><div id="ht" style="width: 545px;height:300px;min-height:200px;margin-left: 10px;overflow:auto;">
                	    			</div>
                	    		</td>
							</tr>
						</tbody>
