...
<script src="<%=basePath %>business/refund/auditRecord/jquery.jqprint-0.3.js"></script>
	...
	<div class="container-fluid" >
		...
		<div class="row-fluid">
			<h3 class="text-primary" >
				<ol class="breadcrumb">
					<li>退料退库</li>
                    <li class="content_top_title_black">审核记录</li>
				</ol>
			</h3>
		</div>
		<hr>
			...
			<div class="row-fluid col-md-12">
				...
				<div id="tbar" class="btn-toolbar">
					...
					<div class="btn-group pull-left visible-lg visible-md visible-sm" >
						<button class="btn btn-primary" id="btn_return" type="button">
...
<!-- 不要改变以下引用顺序 -->
<%@include file="record_edit.jsp"%>
<%@include file="record_details.jsp"%>
<%@include file="record_label.jsp"%>
<script src="record_def.js"></script> 
<script src="record_list.js"></script>