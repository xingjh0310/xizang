					...
					<table class="table table-bordered info_table_css">
						<tr>
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="SUPPLIERPLANCODE_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">供&nbsp;&nbsp;应&nbsp;商：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="SUPPLIERNAME_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="CONTRACTNO_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">合同标题：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="CONTRACTNAME_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="CONTRACTNUM_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">物料名称：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="MATERIELNAME_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="MATERIALNORMS_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">计量单位：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="MEAUNIT_arrival">100</lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="PLANDELIVERIE_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">实际交货量：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="ACTUALDELIVERIE_arrival"></lable>
							</td>
						</tr>
						<tr>
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="PLANDELIVERYBATCH_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">申请日期：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="APPLYDATE_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="DEMANDUNIT_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">项目单位：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="DEPTNAME_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="CONTRACTDELIVERYDATE_arrival"></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">确认交货期：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="CONFIRMDELIVERYDATE_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="SUPPLYDELIVERYDATE_arrival" ></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">需求部门 &nbsp;&nbsp;&nbsp;<br>建议交货期：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="DEPTDELIVERYDATE_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="RECEIVECONTACT_arrival" ></lable>
							</td>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                            	<label style="margin:0">联系电话：</label>
							</td>
							<td style="width:200px;">
								<lable style="margin-left: 15px;" id="LINKMODE_arrival"></lable>
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td colspan="3">
                	 			<lable  style="margin-left: 15px;" id="DELIVERYPLACE_arrival"></lable>
                	 		</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
							...
							<td colspan="3">
                	 			<lable  style="margin-left: 15px;" id="MATERIELDESC_arrival"></lable>
                	 		</td>
						</tr>
						<tr>
                 	 		<td style="width:100px;text-align:right;font-weight:bold;background: #f9f9f9">
                	 		...
                	 		<td colspan="3">
                	 			<lable  style="margin-left: 15px;" id="REMARK_arrival"></lable>
                	 		</td>
                  		</tr> 
					</table>
				</div>
