		...
		this.InitData=function(opt){
			...
			function queryParams(params) {  // 配置参数
				...
				var opt_parms={
					...
					//,"fArrivalFormBean.mArrival.planState"		:"0"
				};
...
//			    	alert(temp);
		...
		this.InitAddEditDel=function(opt){
			...
			opt_all.btn_report.bind("click",reportList)
		...
		//跳转已上报页面
		function reportList(){
			window.location.href=basePath+"business/plan/arrivalList/arrival.jsp"
		}
