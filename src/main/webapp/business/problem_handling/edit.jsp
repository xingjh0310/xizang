		...
		<div class="modal-dialog modal-lg" style="width:700px">
			<div class="modal-content">
				...
				<div class="modal-header" style="height: 40px">
					...
					<h4 class="modal-title modal_header_top">处理结果录入</h4>
				</div>

					<div class="modal-body" style="max-height: 500px;overflow:overlay">
					...
					<h4 class="model_title_margin_top"><i class="icon icon-tags"></i>&nbsp;问题情况</h4>
					
                    <table class="table table-bordered table-condensed info_table_css" id="table">
						<tbody>
							<tr>
								<td
					...
					<div class="model_title2_margin_top"><h4> <i class="icon icon-tags"></i>&nbsp;问题处理结果</h4></div>
					...
					<div class="form-group" style="margin-top: -10px">
						...
						<div class="col-md-4 rowGroup" style="margin-top: -7px;">
							...
							<label class="input" style="display:inline;">
               				<input type='text' class="form-control laydate" style="width: 173px; height: 32px;"  readonly="readonly" 
               					   id="PROCESSTIME" 
               					   required
               					   data-bv-group=".rowGroup"
                  ...
                  <div class="form-group add_img" style="margin-bottom:0px">
