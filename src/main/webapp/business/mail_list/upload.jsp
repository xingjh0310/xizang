		...
		<div class="modal-dialog modal-lg" style="width:680px">
			<div class="modal-content">
				...
				<div class="modal-header" style="height: 40px">
					...
					<h4 class="modal-title" style="line-height:15px;"><i class="icon icon-cloud-download">&nbsp;通讯录信息导入</i></h4>
				</div>
				...
				<div class="modal-footer" style="height: 40px;">
					<button type="button" class="btn btn-large" data-dismiss="modal" style="margin-top: -14px;margin-right:-12px">
						<i class="icon icon-times" style="margin-right: 4px;"></i> 取消
					</button>
				</div>
			</div>
		</div>
