	...
	<div class="container-fluid" >
		...
		<div class="row-fluid top-title">
			<h3 class="text-primary">
				<ol class="breadcrumb" >
					<li>物资问题</li>
                    <li class="content_top_title_black">问题处理记录</li>
				</ol>
			</h3>
		</div>
		<hr class="hr-title">
			...
			<div id="tbar" class="btn-toolbar">
				...
				<!-- <div class="btn-group">
					<button type="button" class="btn btn-primary">
					   <div class="visible-md visible-lg"><i class="icon icon-plus"></i>&nbsp;导出当前页</div>
					   <div class="visible-xs visible-sm"><i class="icon icon-file-o"></i></div>
					</button>
				</div> -->
				<!-- <div class="btn-group">
					<button type="button" class="btn btn-primary">
					   <div class="visible-md visible-lg"><i class="icon icon-plus"></i>&nbsp;导出全部</div>
					   <div class="visible-xs visible-sm"><i class="icon icon-file-o"></i></div>
					</button>
				</div> -->
			...
			<table id="tbinfo" class="table-condensed table-hover table-cursor" >
				<thead>
					<tr>
						...
						<th data-halign="center" data-align="center" data-sortable="false" data-width="180" data-formatter="FMT_Oper">操作</th> -->
					</tr>
				</thead>
			</table>
