	...
	<div class="container-fluid" >
		...
		<div class="row-fluid">
			<h3 class="text-primary" >
				<ol class="breadcrumb">
					<li>物资运输</li>
                    <li class="content_top_title_black">物资状态</li>
				</ol>
			</h3>
		</div>
		<hr>
...
<!-- 不要改变以下引用顺序 -->
<%@include file="material_edit.jsp"%>
<%@include file="material_details.jsp"%>
<%@include file="material_edit_check.jsp"%>
<%@include file="material_check_module.jsp"%>
<script src="material_def.js"></script> 
