		...
		<div class="modal-dialog modal-lg" style="width:550px">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<label class="col-md-3 control-label"> 
                              <span class="text-danger">*&nbsp;</span> 用&nbsp;&nbsp;户&nbsp;名：
						</label>
						<div class="col-md-7">
                            <input type="text" class="form-control" id="name_"
                                ...
                                placeholder="请输入用户名，字数限制50  ，不能为空！"
                            >
						</div>
					</div>
				...
				<div class="modal-footer" style="height: 40px;">
					<button type="button" id="btn_save" class="btn btn-primary" style="margin-top: -14px">
...
var supadmin="${supadmin}"; //超级管理员
var sysRole="${sys_role}"; //超级管理员
</script>
