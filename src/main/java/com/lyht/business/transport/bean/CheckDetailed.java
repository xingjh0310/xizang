...
/**
 * 作者： 陈洪强 日期:2018年3月7日 说明: 物资验收明细
 */
@Entity
@Table(name = "mate_acceptance_detail")
public class CheckDetailed implements Serializable {
	...
	private Integer transportNum;		// 发货数量
	private Integer transferNum; 		// 交接数量
	private String expectDeliveryDate; 	// 预计发货日期
	private String expectArrivalDate; 	// 预计到货日期
	private String expectConDate; 		// 实际交货日期
	...
	@Column(name = "expect_arrival_date", length = 30)
	...
	@Column(name = "expect_con_date", length = 30)
	public String getExpectConDate() {
		return expectConDate;
	}

	public void setExpectConDate(String expectConDate) {
